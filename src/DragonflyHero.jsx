  ...
  return (
    <div className="relative w-full h-screen bg-black text-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6">
        <h1 ref={textRef} className="text-5xl md:text-7xl font-black leading-tight">
          <span className="block">DRAGONFLY BACKS</span>
          <span className="block text-pink-500 font-mono">CRYPTO PROJECTS</span>
        </h1>
